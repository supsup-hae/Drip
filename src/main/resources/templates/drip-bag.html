...
<div class="bg-image" style="background-image: url('../images/drip_bag.jpg'); height: 50vh;">
    <div class="mask" style="background: linear-gradient(
      ...
      hsla(0, 0%, 0%, 1)
        ...
        <footer class="pt-3 ps-4 ms-5 text-white blockquote-footer text-opacity-50">
        </footer>
        <p class="d-flex pt-4 ps-4 ms-5 text-white w-50">
            드립백은 1990년도 기사텐의 고향, 일본 핸드드립 커피문화에서 시작한 일회용 드립커피 키트를 의미한다.
            일본에서 가장 오래된 커피 회사이자 세계 최초로 캔 커피를 시작한 UCC커피를 포함해 다양한 회사에서 드립백을 제작했고,
            최근에는 한국의 스페셜티커피 업체들도 활발하게 생산하고 있다.
        </p>
    </div>
</div>
<%--Header--%>
...
<div>
    <div class="row w-100">
        <div class="col mt-5 ms-2" style="width: 220px">
            <div class="card mt-5">
        ...
        <%
            ...
            List<Product> peerCoffeeProductList = repository.getProductByCategory("DripBag");
